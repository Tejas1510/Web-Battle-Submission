...
const CtaThree = () => {
  return (
    <Box as="section" sx={styles.ctaThree}>
        <SectionHeader
        slogan="Our Stats"
        title="Take a look at the incredible stats of EmPower"
        />
      <Container>
          ...
          <Box sx={styles.ctaThree.colTwo}>
            <Box className="my-auto">
              <Box sx={styles.ctaThree.content}>
                ...
                <Text as="p">
                  {
                    'Today, in the computer age, not all schools teach coding in early childhood resulting in a major gap in the requirements of the new world and our childrens skills. WhiteHat Jr introduces and prepares your kid from 6-18 years for this new coding world. They learn fundamentals of coding--logic, structure, sequence and algorithmic thinking--to generate creative outcomes like animations and apps. All classes are taught Live 1:1 Online in the comfort of your home by Top 1% selected teachers and subject matter experts.'
                  }
                </Text>
                <Link
                  path="#"
...
const styles = {
  ctaThree: {
    paddingTop: [0, null, null, null, 20, 50],
